...
| PAY-003 | Buyer/Provider | Declare one side of an External Cash exchange | Amount/purpose; direct payer-recipient; 0% pilot commission; no custody/refund promise; separate declarations | Declare paid or received | Mismatch/duplicate/uncertain state offers clarification; Work remains unchanged |
| PAY-004 | Buyer/Provider/Admin | Acknowledge cash or handle declaration mismatch | Both declarations; timestamps/actors; disagreement; affected obligation; no automatic recovery promise | Acknowledge or report mismatch | Silence is not proof; mismatch opens dispute/support and preserves history |
| PAY-005 | Buyer/Provider | Submit external digital evidence without overclaiming | Provider/reference; amount/time; screenshot fixture; redaction; no custody/Tiwala; evidence meaning | Submit evidence | Validation/rejection preserves safe resubmission and never labels upload provider-verified |
